...
public class Exercise12 {
    public static void main(String[] args) {
        ...
        for (i = 0; i <= rn; i++) {
            ...
            System.out.printf("[%d] %d\t", i, next);
        }

        rn = (int) (Math.random() * 100); // [0, 99]
        /**
         * min and max are set to upper-bound+1 and lower-bound-1, respectively to
         * ensure the min and max are updated at least 1 time, otherwise it's possible
         * the numbers will never be updated and the values will be incorrect
         * 
         * 
         * FIX
         */
